...
export default function Gamedetails() {
  ...
  return <>
   {idError === 404 ? "":gameDetails.length !== 0 ?<div className="container mg">
      <div className="row">
  ...
  <div className="carousel-inner">
    {
      gameDetails.screenshots.map((img, index) =>
       <div className="carousel-item active" key={index} data-bs-interval={`10000+${index}`}>
